...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, SSKTRD, SSKTRF, SMUL10
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*     Defer workspace query to SSKTRF
            CALL SSKTRF( UPLO, "P", N, A, LDA, IWORK, WORK, LWORK,
     $                   INFO )
         ELSE
*     Defer workspace query to SSKTRD
            CALL SSKTRD( UPLO, "P", N, A, LDA, WORK, WORK, WORK,
     $                   LWORK, INFO)
            WORK(1) = WORK(1) + 2*N - 2
         END IF
      END IF
...
*     Reduce to tridiagonal form
         CALL SSKTRD(UPLO, "P", N, A, LDA, WORK(1), WORK(N),
