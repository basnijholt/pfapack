...
SUBROUTINE check_pfaff_F77_d(UPLO, METHOD, B, RESIDUAL, RELW)
  ...
  REAL(KIND(1.0D0)) :: QUERY(1), PFAFF, RPFAFF
...
SUBROUTINE check_pfaff10_F77_d(UPLO, METHOD, B, RESIDUAL, RELW)
  ...
  REAL(KIND(1.0D0)), ALLOCATABLE :: A(:,:)
  REAL(KIND(1.0D0)), ALLOCATABLE :: WORK(:)
  REAL(KIND(1.0D0)) :: QUERY(1), PFAFF(2), RPFAFF
  INTEGER, ALLOCATABLE :: IWORK(:)
  INTEGER :: INFO, ISTAT, N, LWORK
...
SUBROUTINE check_pfaff10_F95_d(UPLO, METHOD, B, RESIDUAL)
  ...
  REAL(KIND(1.0D0)), ALLOCATABLE :: A(:,:)
  REAL(KIND(1.0D0)) :: PFAFF(2), RPFAFF
  INTEGER :: N, ISTAT
...
SUBROUTINE check_pfaff_band_F77_d(UPLO, A, B, RESIDUAL)
  ...
  REAL(KIND(1.0D0)) :: PFAFF, RPFAFF
  REAL(KIND(1.0D0)), ALLOCATABLE :: AB(:,:)
  REAL(KIND(1.0D0)), ALLOCATABLE :: WORK(:)
