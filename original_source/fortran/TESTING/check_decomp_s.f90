...
SUBROUTINE check_LTL_F77_s(UPLO, B, RESIDUAL, RELW)
  ...
  REAL(KIND(1.0E0)), ALLOCATABLE :: A(:,:), Ac(:,:), U(:,:), T(:,:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: TEMP1(:,:), TEMP2(:,:), WORK(:)
  REAL(KIND(1.0E0)) :: QUERY(1)
...
SUBROUTINE check_LTL_F95_s(UPLO, B, RESIDUAL)
  ...
  REAL(KIND(1.0E0)), ALLOCATABLE :: A(:,:), Ac(:,:), U(:,:), T(:,:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: TEMP1(:,:), TEMP2(:,:)
  INTEGER, ALLOCATABLE :: IPIV(:)
  INTEGER :: ISTAT, N
...
SUBROUTINE check_QTQ_F77_s(UPLO, B, RESIDUAL, RELW)
  ...
  REAL(KIND(1.0E0)), ALLOCATABLE :: A(:,:), Ac(:,:), Q(:,:), T(:,:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: E(:), TAU(:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: TEMP1(:,:), TEMP2(:,:), WORK(:)
  REAL(KIND(1.0E0)) :: QUERY(1)
  INTEGER :: INFO, ISTAT, N, LWORK
...
SUBROUTINE check_QTQ_band_F77_s(UPLO, A, B, RESIDUAL)
  ...
  REAL(KIND(1.0E0)), ALLOCATABLE :: AB(:,:), Q(:,:), T(:,:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: E(:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: TEMP1(:,:), TEMP2(:,:), WORK(:)
  ...
  ALLOCATE(AB(KD+1,N), Q(N,N), T(N,N), TEMP1(N,N), &
       TEMP2(N,N), E(N-1), WORK(2*N), STAT = ISTAT)
  ...
  !compute the factorization
  CALL SKBTRD("V", UPLO, "N", N, KD, AB, MAX(1,SIZE(AB,1)), E, Q, MAX(1,N), WORK, INFO)
