...
SUBROUTINE check_pfaff_F77_c(UPLO, METHOD, B, RESIDUAL, RELW)
  ...
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: A(:,:)
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: WORK(:)
  COMPLEX(KIND(1.0E0)) :: QUERY(1), PFAFF, RPFAFF
  REAL(KIND(1.0E0)), ALLOCATABLE :: RWORK(:)
...
SUBROUTINE check_pfaff_F95_c(UPLO, METHOD, B, RESIDUAL)
  ...
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: A(:,:)
  COMPLEX(KIND(1.0E0)) :: PFAFF, RPFAFF
  INTEGER :: N, ISTAT
...
SUBROUTINE check_pfaff10_F77_c(UPLO, METHOD, B, RESIDUAL, RELW)
  ...
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: A(:,:)
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: WORK(:)
  COMPLEX(KIND(1.0E0)) :: QUERY(1), PFAFF(2), RPFAFF
  REAL(KIND(1.0E0)), ALLOCATABLE :: RWORK(:)
  INTEGER, ALLOCATABLE :: IWORK(:)
  INTEGER :: INFO, ISTAT, N, LWORK
...
SUBROUTINE check_pfaff10_F95_c(UPLO, METHOD, B, RESIDUAL)
  ...
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: A(:,:)
  COMPLEX(KIND(1.0E0)) :: PFAFF(2), RPFAFF
  INTEGER :: N, ISTAT
...
SUBROUTINE check_pfaff_band_F77_c(UPLO, A, B, RESIDUAL)
  ...
  COMPLEX(KIND(1.0E0)) :: PFAFF, RPFAFF
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: AB(:,:)
  COMPLEX(KIND(1.0E0)), ALLOCATABLE :: WORK(:)
  REAL(KIND(1.0E0)), ALLOCATABLE :: RWORK(:)
