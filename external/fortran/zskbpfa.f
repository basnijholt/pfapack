      SUBROUTINE ZSKBPFA( UPLO, N, KD, AB, LDAB, PFAFF, WORK, RWORK,
     $                    INFO )
*
...
*  =======
*
*  ZSKBPFA computes the Pfaffian of a complex skew-symmetric band matrix.
*
*  Arguments
*  =========
*
