      SUBROUTINE CSKTRD( UPLO, MODE, N, A, LDA, E, TAU, WORK, LWORK,
     $                   INFO )
*
...
*  =======
*
*  CSKTRD reduces a complex skew-symmetric matrix A to real skew-symmetric
...
*  ===============
*
*  The normal use for CSKTRD is to compute the tridiagonal form of
*  a skew-symmetric matrix under an orthogonal similarity transformation,
*  and chosen by setting MODE = 'N' ("normal" mode). The other
*  use of CSKTRD is the computation the Pfaffian of a skew-symmetric matrix,
...
*
*  The LAPACK routine CUNGTR can be used to form the transformation
*  matrix explicitely, and CUNMTR can be used to multiply another
...
*  or in the even columns (if UPLU = 'U') are properly computed by CSKTRD.
*
...
*  element not computed by CSKTRD.
*
*  =====================================================================
*
*     .. Parameters ..
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, CSKR2K, CSKTD2, CLASKTRD
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*        NOTE: I keep 'CHETRD" here, as of course ILAENV has no information
*              about CSKTRD ...
...
*           the matrix
*
            CALL CLASKTRD( UPLO, MODE, I, NB, A, LDA, E, TAU, WORK,
     $                     LDWORK )
*
*           Update the unreduced submatrix A(1:i-npanel,1:i-npanel), using an
*           update of the form:  A := A + V*W^T - W*V^T
*
            CALL CSKR2K( UPLO, 'No transpose', I-NPANEL, NB, CONE,
...
*
         CALL CSKTD2( UPLO, MODE, I, A, LDA, E, TAU, IINFO )
      ELSE
*
...
*           the matrix
*
            CALL CLASKTRD( UPLO, MODE, N-I+1, NB, A( I, I ), LDA,
     $                     E( I ), TAU( I ), WORK, LDWORK )
*
*           Update the unreduced submatrix A(i+npanel:n,i+npanel:n), using
*           an update of the form:  A := A + V*W^T - W*V^T
*
            CALL CSKR2K( UPLO, 'No transpose', N-I-NPANEL+1, NB, CONE,
...
*        Use unblocked code to reduce the last or only block
*
         CALL CSKTD2( UPLO, MODE, N-I+1, A( I, I ), LDA, E( I ),
     $                TAU( I ), IINFO )
      END IF
*
      WORK( 1 ) = LWKOPT
